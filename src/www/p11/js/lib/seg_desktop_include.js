...
//document.write('<script language="javascript" type="text/javascript" src="/js/lib/i-docs.js"></script>');
document.write('<script language="javascript" type="text/javascript" src="/p11/js/lib/i-content.js"></script>');
